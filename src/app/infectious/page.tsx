...
import { getInfectiousData, getInfectiousDataLength } from "@/lib/actions";
import type { FC } from "react";
import InfectiousData from "@/data/infectious.json";
...
const page: FC<pageProps> = ({}) => {
	...
	return (
		<main className='max-w-6xl bg-white mx-auto py-8 rounded-t-lg container'>
			...
			<Table
				filePath='infectious.csv'
				headerMap={headerMap}
				loadData={getInfectiousData}
				getLength={getInfectiousDataLength}
			/>
		</main>
	);
};
